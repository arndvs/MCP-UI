...
type McpMessageTypes = {
	...
	// Added prompt message type to enable sending prompts to the AI agent
	// This allows the UI to request AI assistance without directly calling tools
...
// Function overload for prompt message type
// This provides type safety when sending prompts to the AI agent
function sendMcpMessage<Options extends MessageOptions>(
	type: 'prompt',
