			...
			return {
				content: [
					createUIResource({
						...
						encoding: 'text',
						// UI metadata allows us to control how the UI resource is displayed
						// The preferred-frame-size tells the MCP client what dimensions
						// would work best for this specific UI component
						uiMetadata: {
							// Array format: [width, height] in CSS units
							// Width: 600px provides good readability without taking up entire chat
							// Height: 800px matches the max-height set in the journal-viewer UI
							// This prevents double scrollbars and provides optimal UX
