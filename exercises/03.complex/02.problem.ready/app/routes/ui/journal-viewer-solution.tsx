...
export default function JournalViewer({ loaderData }: Route.ComponentProps) {
	...
	// Notify the parent window that this iframe UI has finished rendering and is ready
	// This is crucial for the parent to know when it's safe to start sending events and data
	// Some agents may wait for this signal before continuing generation or other operations
	useEffect(() => {
