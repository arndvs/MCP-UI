...
// Now importing the Remote DOM script function instead of raw HTML
			...
			return {
				content: [
					createUIResource({
						uri: `ui://view-tag/${id}`,
						content: {
							// Changed from 'rawHtml' to 'remoteDom' for consistent UI
							type: 'remoteDom',
							// Framework specification tells the host app how to render UI components
							// The host application decides what ui-stack, ui-text, etc. look like
							framework: 'react',
							// Using JavaScript script instead of HTML string
							// This script runs in isolated iframe but results are copied to main app
